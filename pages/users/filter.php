<?php
    ...
    if (!isset($viewResults)) {$viewResults = array();}

	$content = loadTemplate('../templates/users/searchTemplate.php', ['brands'=>$brands,'brandlist'=>$brandlist,'viewResults'=>$viewResults]);
?>